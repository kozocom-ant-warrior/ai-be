...
- Học vấn: {cv.get('education', {}).get('degree', 'N/A')}"""
    ...
    if advanced_options.get("cvPresentation", False):
        ...
        requirements_text += """
- cv_presentation_comment (OBJECT - mỗi field 1-2 câu):
  * structure: Layout/sections (VD: chronological, 4 sections)
  * strengths: 3 điểm mạnh có evidence (metrics/projects)
  * issues: 3 vấn đề cần fix (format/content/grammar)
  * highlights: 1-2 achievements nổi bật
  * suggestions: 3 actions cụ thể"""
